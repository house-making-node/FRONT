...
const ShareLetterSend = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://3.36.240.5:3000/share_letters/2/opinions', opinionData, {
        headers: {
  ...
  const handleButtonClick = () => {
    navigate('/share-letter-send-complete');
  };
  ...
  return (
    <PageContainer>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <FormGroup>
          <Label>6. 공유레터에서 다루었으면 하는 주제, 내용, 기타 의견이 있다면 자유롭게 적어주세요!</Label>
          <TextArea
            name="otherFeedback"
